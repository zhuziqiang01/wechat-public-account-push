export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  // APP_ID: "wxad27c419b9503539",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  // APP_SECRET: "dcc600e0b2da4c4e6170ac7be9f00925",
   ...
   *    openUrl: "https://s.weibo.com/top/summary?cate=socialevent"
   *   }, 
   * ]
   */
  USERS: [
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "ola_p6Y6rlbjgAyBjmT_p0dQYKwY",
    }, 
  ],
